...
const librarySlots = [
  ...
  },
  {
    ...
    id: "dimension-6",
    library: "\u7ef4\u5ea6\u8868",
    label: "Dim-领星与金蝶仓库对照表",
  },
  {
    store: "dimension-files",
    id: "dimension-7",
    library: "\u7ef4\u5ea6\u8868",
    label: "Dim-领星SKU对应物料编码-产品管理",
  },
  {
    store: "dimension-files",
    id: "dimension-8",
    library: "\u7ef4\u5ea6\u8868",
    label: "Dim-店铺名称汇总（金蝶&领星&简称）",
  },
  {
    store: "dimension-files",
    id: "dimension-9",
...
async function clearLibraryCache() {
  const confirmed = window.confirm("\u786e\u8ba4\u6e05\u9664\u5f53\u524d\u9875\u9762\u7684\u7ef4\u5ea6\u8868\u6587\u4ef6\u5e93\u7f13\u5b58\u5417\uff1f\u6e05\u9664\u540e\u9700\u8981\u91cd\u65b0\u4e0a\u4f20\u5e76\u786e\u8ba4\u5e94\u7528\u5237\u65b0\u3002");
  if (!confirmed) return;
